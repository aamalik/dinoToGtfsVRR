...
for filename in os.listdir("/Users/asfandyar/IdeaProjects/dinoToGtfsVRR/dino_vrr/dino_vrr_20170307/"):
    if filename.endswith(".din"):
        print('Loading {}'.format(filename))
        df = pd.read_csv('/Users/asfandyar/IdeaProjects/dinoToGtfsVRR/dino_vrr/dino_vrr_20170307/' + filename, delimiter=';', skipinitialspace=True,
